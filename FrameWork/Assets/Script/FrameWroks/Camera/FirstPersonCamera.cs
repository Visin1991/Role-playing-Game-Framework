...
{ 
    //Notes:
    // For First person Camera, the Camera' rotation need match to the body of the player
    public class FirstPersonCamera : MonoBehaviour,PlayerCamera
    {
        ...
        public void UpdateCamera()
        {
            ...
            transform.position = targetTransform.position + distToTarget;
            //transform.position = targetTransform.position + targetTransform.forward * lengthToTarget;
        ...
        public void InitialCamera()
        {
            ...
            distToTarget = transform.position - targetTransform.position;
            lengthToTarget = distToTarget.magnitude;
        }
